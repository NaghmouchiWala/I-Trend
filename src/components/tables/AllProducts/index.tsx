...
export function AllProducts({
  ...
  // We might need to update filter hook to be company-aware
  ...
  // Fetch products based on selected company and other filters
            ...
            <Table>
              <TableHeader>
                <TableRow>
                  ...
                  <TableHead className="hidden md:table-cell w-[150px]">Catégorie</TableHead>
                  <TableHead className="hidden md:table-cell w-[150px]">Marque</TableHead>
                  <TableHead className="w-[130px]">Disponibilité</TableHead>
            ...
            <div className="flex items-center gap-2">
              <div className="text-xs text-muted-foreground">
                <strong>
                  {Math.max(
                    0,
                    Math.min(offset - productsPerPage, totalProducts ?? 0) + 1
                  )}
                  -{offset}
                </strong>{' '}
